...
class PersonalDetails extends Component {
    state = {
        firstName: '',middleName: '', surname: '',nationalId: '',
        SelectedGenderId: "",
        genderCategories: [
            { label: "Male", value: "1" },
    ...
    handleSubmit = (event) => {
        ...
        this.setState({firstNameHasError: false,surnameHasError: false, middleNameHasError: false,phoneNumberHasError: false});
       if(this.containsANumber(this.state.firstName)) {
           this.setState({firstNameHasError: true,firstNameErrorMessage: 'Name must not contain a number'});
       } else if(this.containsANumber(this.state.surname)) {
           this.setState({surnameHasError: true,surnameErrorMessage: 'Name must not contain a number'});
       } else if(this.containsANumber(this.state.middleName)) {
           this.setState({middleNameHasError: true,middleNameErrorMessage: 'Name must not contain a number'});
       } else if(isNaN(this.state.phoneNumber)) {
           this.setState({phoneNumberHasError: true,phoneNumberErrorMessage: 'Phone number must not contain a letter'});
       } else {
                                ...
                                <Columns>
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="firstName"
                                                className={this.state.firstNameHasError
                                    ...
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="middleName"
                                                className={this.state.middleNameHasError
                                                    ? 'form-control personal__text-area-error'
                                                    : 'form-control'}
                                ...
                                <Columns>
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="surname"
                                                className={this.state.surnameHasError
                                                    ? 'form-control personal__text-area-error'
                                                    : 'form-control'}
                                                placeholder="Surname"
                                    ...
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <div className="form-group">
                                                <Select
                                                    className={this.state.SelectedGenderIdHasError
                                ...
                                <Columns>
                                    ...
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="nationalId"
                                                className={this.state.nationalIdHasError
                                                    ? 'form-control personal__text-area-error'
                                                    : 'form-control'}
                                ...
                                <Columns>
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="phoneNumber"
                                                className={this.state.phoneNumberHasError
                                                    ? 'form-control personal__text-area-error'
                                                    : 'form-control'}
                                    ...
                                    <Columns.Column size="one-half">
                                        <div className="form-group">
                                            <input
                                                name="email"
                                                className={this.state.emailHasError
                                                    ? 'form-control personal__text-area-error'
                                                    : 'form-control'}
                                                placeholder="Email"
                                    ...
                                    <Columns.Column size="one-half">
                                            ...
                                            <div className="form-group">
                                                <input
                                                    ...
                                                    className={this.state.physicalAddressHasError
                                                        ? 'form-control personal__text-area-error'
                                                        : 'form-control'}
